# =============================================================================
# Quick Deploy Script for Interview Microservice ABC
# =============================================================================
# Description: Comprehensive deployment script with health checks and monitoring
...
# CONFIGURATION
# =============================================================================
$ScriptName = "Quick Deploy Script"
$Version = "2.0.0"
$MaxRetries = 30
$RetryInterval = 2
...
function Test-EnvironmentFile {
    if (-not (Test-Path ".env")) {
        Write-Step ".env file not found. Please run '.\quick-build.ps1' first." "ERROR"
        return $false
    }
    return $true
}
...
function Show-Help {
    ...
    Write-Host "`nUsage: .\quick-deploy.ps1 [options]" -ForegroundColor Yellow
    ...
    Write-Host "  .\quick-deploy.ps1                    # Deploy all services" -ForegroundColor White
    Write-Host "  .\quick-deploy.ps1 -Service auth      # Deploy only auth-service" -ForegroundColor White
    Write-Host "  .\quick-deploy.ps1 -Monitor           # Deploy with monitoring" -ForegroundColor White
    Write-Host "  .\quick-deploy.ps1 -WaitTime 20       # Custom wait time" -ForegroundColor White
}
...
# Deploy services
Write-Step "Starting deployment process..." "INFO"
$deploymentSuccess = Deploy-Services -ServiceName $Service
...
if ($deploymentSuccess) {
    ...
    Write-Host "  • Run '.\quick-deploy.ps1 -Monitor' for real-time monitoring" -ForegroundColor White
    ...
    Write-Host "For help, run: .\quick-deploy.ps1 -Help" -ForegroundColor Cyan
    exit 1
}
