...
# Create Question
$questionBody = "{`"topicId`":1`,`"levelId`":1`,`"typeId`":1`,`"content`":`"Test Question?`"`,`"createdBy`":1}"
...
# Create Exam
$examBody = "{`"userId`":1`,`"examType`":`"VIRTUAL`"`,`"title`":`"Test Exam`"`,`"position`":`"Dev`"`,`"topics`":`"[1]`"`,`"questionTypes`":`"[1]`"`,`"questionCount`":10`,`"duration`":30`,`"language`":`"Vietnamese`"}"
