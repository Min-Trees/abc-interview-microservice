...
# Test User Service
Write-Host "`n👤 Testing User Service..." -ForegroundColor Blue
...
# Test Career Service
Write-Host "`n🎯 Testing Career Service..." -ForegroundColor Blue
...
Write-Host "`n❓ Testing Question Service..." -ForegroundColor Blue
...
# Test Exam Service
Write-Host "`n📝 Testing Exam Service..." -ForegroundColor Blue
...
# Test News Service
Write-Host "`n📰 Testing News Service..." -ForegroundColor Blue
...
# Test NLP Service
Write-Host "`n🤖 Testing NLP Service..." -ForegroundColor Blue
